  ...
  return (
    ...
    <Link className='text-3xl font-bold tracking-tight text-white sm:text-4xl' to='/login'>
        <h1>SIGN IN</h1>
            ...
            {user ? (
                <p className="px-4 py-2 bg-red-500 text-white font-semibold rounded-lg shadow-md hover:bg-red-700 transition-colors duration-300" onClick={logoutUser} >Logout</p>
            ):
            (
